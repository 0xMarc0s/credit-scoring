...
/* , 1/(1+exp(-(-0.03588230636718269*(0.0+ calculated PSC_act_age+ calculated PSC_act_cc+ calculated PSC_app_number_of_children+ calculated PSC_act_ccss_n_statC+ calculated PSC_act_ccss_maxdue+ calculated PSC_act9_n_arrears)+(18.5703023726095)))) as PD */ 
